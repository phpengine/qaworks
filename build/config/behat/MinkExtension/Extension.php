...
//            end()->
            scalarNode('os')->
            defaultValue(isset($config['selenium2']['capabilities']['os']) ? $config['selenium2']['capabilities']['os'] : 'Windows')->
            end()->
//            scalarNode('os_version')->
//            defaultValue(isset($config['selenium2']['capabilities']['os_version']) ? $config['selenium2']['capabilities']['os_version'] : '7')->
//            end()->
//            scalarNode('browser_version')->
//            defaultValue(isset($config['selenium2']['capabilities']['browser_version']) ? $config['selenium2']['capabilities']['browser_version'] : "9")->
//            end()->
//            scalarNode('browserstack.local')->
//            defaultValue(isset($config['selenium2']['capabilities']['browserstack.local']) ? $config['selenium2']['capabilities']['browserstack.local'] : false )->
//            end()->
